...
I'm a data professional focused on building scalable data solutions that drive business value. My expertise lies at the intersection of data engineering, business intelligence, and security analytics.

- 🔐 Architected a **Security Configuration & Compliance Monitoring System** that provides real-time visibility into database security posture
- 💼 Built advanced **Power BI dashboards** with complex DAX measures and row-level security to deliver actionable insights
- ✉️ Implemented **automated alerting systems** that reduce incident response time by 65%
- 📊 Specialized in creating **end-to-end data solutions** - from data integration to visualization and analytics
- 💡 Passionate about **data modeling** and designing **performant, scalable architectures** that solve real business problems
...
- **SQL**: Complex Joins, Window Functions, CTEs, Stored Procedures, Performance Tuning
- **Python**: Pandas, NumPy, Matplotlib, Seaborn, scikit-learn, Streamlit
- **Cloud**: Azure Data Factory, Azure SQL, Databricks (Basics)
- **Version Control**: Git, GitHub Actions, CI/CD for Data Projects
- **Collaboration**: Agile Methodology, JIRA, Confluence
...
jobs:
  ...
  <!-- Title -->
  <text x="400" y="40" font-family="Arial" font-size="24" fill="#58a6ff" text-anchor="middle">Data Engineering Journey</text>
  
  <!-- X and Y Axis -->
  <line x1="100" y1="350" x2="700" y2="350" stroke="#30363d" stroke-width="2"/>
  ...
  <text x="620" y="380" font-family="Arial" font-size="14" fill="#8b949e" text-anchor="middle">2025</text>
  
  <!-- Y Axis Labels -->
  <text x="80" y="350" font-family="Arial" font-size="12" fill="#8b949e" text-anchor="end">Beginner</text>
  <text x="80" y="275" font-family="Arial" font-size="12" fill="#8b949e" text-anchor="end">Intermediate</text>
  <text x="80" y="200" font-family="Arial" font-size="12" fill="#8b949e" text-anchor="end">Advanced</text>
  <text x="80" y="125" font-family="Arial" font-size="12" fill="#8b949e" text-anchor="end">Expert</text>
  
  <!-- Data Points & Connecting Line -->
  <polyline 
    points="100,320 230,280 360,220 490,180 620,130" 
    fill="none" 
    stroke="#58a6ff" 
    stroke-width="3"
  />
  
  <!-- Skill Milestones - Circles with Tooltip Texts -->
  <circle cx="100" cy="320" r="8" fill="#238636"/>
  <text x="100" y="305" font-family="Arial" font-size="11" fill="#58a6ff" text-anchor="middle">SQL Basics</text>
  
  <circle cx="230" cy="280" r="8" fill="#238636"/>
  <text x="230" y="265" font-family="Arial" font-size="11" fill="#58a6ff" text-anchor="middle">Power BI Essentials</text>
  
  <circle cx="360" cy="220" r="8" fill="#238636"/>
  <text x="360" y="205" font-family="Arial" font-size="11" fill="#58a6ff" text-anchor="middle">Advanced SQL & PL/SQL</text>
  
  <circle cx="490" cy="180" r="8" fill="#238636"/>
  <text x="490" y="165" font-family="Arial" font-size="11" fill="#58a6ff" text-anchor="middle">Python Data Engineering</text>
  
  <circle cx="620" cy="130" r="8" fill="#238636"/>
  <text x="620" y="115" font-family="Arial" font-size="11" fill="#58a6ff" text-anchor="middle">Cloud Data Platforms</text>
  
  <!-- Legend -->
  <rect x="600" y="60" width="150" height="60" fill="#161b22" rx="5" ry="5"/>
  <circle cx="620" cy="80" r="6" fill="#238636"/>
  <text x="635" y="85" font-family="Arial" font-size="12" fill="#8b949e">Skill Milestone</text>
  <line x1="610" y1="105" x2="630" y2="105" stroke="#58a6ff" stroke-width="3"/>
  <text x="635" y="110" font-family="Arial" font-size="12" fill="#8b949e">Skill Progression</text>
</svg>
